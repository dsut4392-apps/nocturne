...
namespace Nocturne.Connectors.Glooko.Models
{
    ...
    public class GlookoV3UsersResponse
    {
        ...
        public GlookoV3User? CurrentUser { get; set; }

        [JsonPropertyName("currentPatient")]
        public GlookoV3User? CurrentPatient { get; set; }
    }
    ...
    public class GlookoV3User
    {
        ...
        public GlookoV3Preference? Preference { get; set; }
    ...
    public class GlookoV3LastSyncTimestamps
    {
        ...
        [JsonPropertyName("cgmDevice")]
        public string? CgmDevice { get; set; }

        [JsonPropertyName("insulinPen")]
        public string? InsulinPen { get; set; }
