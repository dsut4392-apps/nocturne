...
export const DeviceHealthReportSchema = z.object({ "deviceId": z.string().optional(), "periodStart": z.string().datetime({ offset: true }).optional(), "periodEnd": z.string().datetime({ offset: true }).optional(), "averageHealthScore": z.number().optional(), "uptimePercentage": z.number().optional(), "totalAlerts": z.number().int().optional(), "healthTrend": z.any().optional(), "keyMetrics": z.record(z.any()).optional() }).strict();
...
export const FeatureSettingsSchema = z.object({ "display": z.any().optional(), "dashboardWidgets": z.any().optional(), "plugins": z.record(z.any()).optional(), "battery": z.any().optional() }).strict();
